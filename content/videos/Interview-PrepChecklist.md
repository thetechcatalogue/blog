...
- [ ] OS-Concepts
- [ ] Networking Concepts
- [ ] Language Specific coding concepts
- [ ] Memory Concepts
- [ ] Virtualization 

### DSA - Coding 
- [ ] Major Algorithm List
- [ ] Problems with major algorithms
...
- [ ] REST - GRPC - SOAP - etc. protcols
- [ ] Implementing Basic blocks - LRU-Cache , Locks, threading etc. 


### System Design 
- Databases / Servers / Caches / Networks 
- Cloud Design Patterns 
- Various Protocls
- Algorithms used in famous cloud solutions 
- Problems and solutions of basic cloud systems
- Kubernetes / VMs / container 
- CI/CDs
- Security and Saftey in Systems
- Scaling / Maintainability

### Cloud Information 
- Azure / AWZ / GCP or any other cloud
- Basic Understanding of any cloud 
- 
