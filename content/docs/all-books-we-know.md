...
description: Curated list of books every software engineer should read.
---
...
| Book | Why Read It |
|------|-------------|
| [Fundamentals of Software Architecture](https://learning.oreilly.com/library/view/fundamentals-of-software/9781492043447/) — Mark Richards & Neal Ford | The definitive guide to architecture styles, patterns, and the soft skills needed to be an effective architect. |
